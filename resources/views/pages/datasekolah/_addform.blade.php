<div class="row">
  <div class="col">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8">
        <input type="number" value="{{ old('nipkepsek') }}" class="form-control @error('nipkepsek') is-invalid @enderror " name="nipkepsek" id="nipkepsek" placeholder="Masukkan nipkepsek">
        @error('nipkepsek')
        <span class="invalid-feedback mt-1">
          {{ $message }}
        </span>
